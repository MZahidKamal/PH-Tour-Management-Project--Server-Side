...
const seedSuperAdminFunction = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isSuperAdminExists) {
        (0, consolePrintFunction_1.consolePrint)('Super admin already exists.');
        return;
    }
    if (!isSuperAdminExists) {
        ...
        (0, consolePrintFunction_1.consolePrint)('New Super Admin created successfully:', { name, email, role });
        return;
    }
});
