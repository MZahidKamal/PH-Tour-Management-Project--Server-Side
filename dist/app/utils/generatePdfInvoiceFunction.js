...
const consolePrintFunction_1 = require("./consolePrintFunction");
    ...
    try {
        return new Promise((resolve, reject) => {
            ...
            document
                .font("Helvetica")
                .fontSize(10)
                .text(`Transaction ID: ${invoiceData.transactionId}`, 60 + contentWidth / 2, 52, {
                width: contentWidth / 2 - 10,
                align: "right"
            })
                .text(`Booking Date: ${formatDate(invoiceData.bookingDate)}`, 60 + contentWidth / 2, 68, {
                width: contentWidth / 2 - 10,
                align: "right"
            });
            ...
            document
                ...
                .fontSize(10)
                .fillColor(textMuted)
                .text(invoiceData.customerName, 50 + contentWidth / 2, cursorY + 16, {
                width: contentWidth / 2,
                align: "left"
            })
                .text(`Tour: ${invoiceData.tourTitle}`, 50 + contentWidth / 2, cursorY + 30, {
                width: contentWidth / 2,
                align: "left"
            });
            cursorY += 80;
            ...
            document
                ...
                .fontSize(11)
                .fillColor(textDark)
                .text(`${invoiceData.guestsCount} guest(s)`, boxLeftX + boxColWidth, cursorY + 28, {
                width: boxColWidth - 10
            });
            // Booking date
            document
                ...
                .fontSize(10)
                .fillColor(textMuted)
                .text("Booking Date", boxLeftX + boxColWidth * 2, cursorY + 12);
            document
                .font("Helvetica")
                .fontSize(11)
                .fillColor(textDark)
                .text(formatDate(invoiceData.bookingDate), boxLeftX + boxColWidth * 2, cursorY + 28, {
                width: boxColWidth - 10
            });
            cursorY += 90;
            // ---------- AMOUNT TABLE ----------
            ...
            document
                ...
                .font("Helvetica")
                .fontSize(10)
                .text(`Tour Package – ${invoiceData.tourTitle}`, tableLeft + 10, itemTop + 7, {
                width: contentWidth * 0.5 - 20
            })
                .text(`${invoiceData.guestsCount}`, tableLeft + contentWidth * 0.55, itemTop + 7, {
                width: 60,
                align: "right"
            })
                .text(formatCurrency(invoiceData.totalAmount), tableLeft + contentWidth * 0.75, itemTop + 7, {
                width: 80,
                align: "right"
            });
            ...
            document
                ...
                .fillColor(textDark)
                .text(formatCurrency(invoiceData.totalAmount), totalsLeft + 100, totalsTop, {
                width: 100,
                align: "right"
            });
            // Total
            ...
            document
                ...
                .text(formatCurrency(invoiceData.totalAmount), totalsLeft + 100, totalRowY, {
                width: 100,
                align: "right"
            });
            // ---------- FOOTER ----------
            document
                ...
                .fontSize(9)
                .fillColor("#9CA3AF")
                .text("Thank you for choosing PH Tour. This is a system generated invoice and does not require a signature.", 50, document.page.height - 80, {
                width: contentWidth,
                align: "center"
            });
            // ---------- Save PDF to Disk ----------
        ...
        throw new AppError_1.default(http_status_codes_1.default.INTERNAL_SERVER_ERROR, "Failed to generate invoice PDF");
    }
});
