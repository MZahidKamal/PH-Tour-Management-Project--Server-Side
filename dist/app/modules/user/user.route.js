...
router.get("/this_user/:thisUserId", (0, jwtRoleVerificationMiddleware_1.default)(...Object.values(user_interface_1.RoleEnum)), user_controller_1.UserControllers.getThisSingleUserController);
router.get("/:userId", (0, jwtRoleVerificationMiddleware_1.default)(user_interface_1.RoleEnum.ADMIN, user_interface_1.RoleEnum.SUPER_ADMIN), user_controller_1.UserControllers.getASingleUserController);
